...
from redis_admin import __about__ as metadata

# Init the Django settings
os.environ['DJANGO_SETTINGS_MODULE'] = 'test_redis_admin.settings'
django.setup()
...
latex_documents = [
    (
        ...
        f'{metadata.__package_name__.replace("-", " ").capitalize()} Documentation',
        metadata.__author__,
        'manual',
    )
]
